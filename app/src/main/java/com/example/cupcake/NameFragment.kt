...
class NameFragment : Fragment() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            android.R.id.home -> {
                if (sharedViewModel.name.value!!.isNotEmpty() || sharedViewModel.surname.value!!.isNotEmpty() || sharedViewModel.phone.value!!.isNotEmpty() || sharedViewModel.adress.value!!.isNotEmpty()) {
                    sharedViewModel.setName("")
                    sharedViewModel.setSurname("")
                    sharedViewModel.setNumber("")
                    sharedViewModel.setAdress("")
                }
